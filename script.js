...
button.addEventListener("click", function () {
    ...
    let textnode = document.createTextNode("Your conservative caffeine window is between " + delaytimelate + " and " + latesttimelate)
    let textnodetwo = document.createTextNode("Your riskier caffeine window is between " + delaytimeearly + " and " + latesttimeearly)
